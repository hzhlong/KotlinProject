package com.kotlin.utilslibrary.widgets.alertView;
...
import com.kotlin.utilslibrary.R;
...
public class AlertView {
    ...
    private AlertView.Style style = AlertView.Style.Alert;
    ...
    public AlertView(AlertView.Builder builder) {
    ...
    public AlertView(String title, String msg, String cancel, String[] destructive, String[] others, Context context, AlertView.Style style, OnItemClickListener onItemClickListener){
    ...
    protected void initData(String title, String msg, String cancel, String[] destructive, String[] others) {
        ...
        if (cancel != null){
            this.cancel = cancel;
            if(style == AlertView.Style.Alert && mDatas.size() < HORIZONTAL_BUTTONS_MAXCOUNT){
    ...
    protected void initListView(){
        ...
        //把cancel作为footerView
        if(cancel != null && style == AlertView.Style.Alert){
            ...
            tvAlert.setOnClickListener(new AlertView.OnTextClickListener(CANCELPOSITION));
    ...
    protected void initActionSheetViews(LayoutInflater layoutInflater) {
        ...
        tvAlertCancel.setOnClickListener(new AlertView.OnTextClickListener(CANCELPOSITION));
    }
    protected void initAlertViews(LayoutInflater layoutInflater) {
        ...
        if(mDatas.size()<=HORIZONTAL_BUTTONS_MAXCOUNT){
            ...
            for (int i = 0; i < mDatas.size(); i ++) {
                ...
                tvAlert.setOnClickListener(new AlertView.OnTextClickListener(position));
                position++;
    ...
    public static class Builder {
        ...
        public AlertView.Builder setContext(Context context) {
            this.context = context;
            return this;
        }

        public AlertView.Builder setStyle(AlertView.Style style) {
            if(style != null) {
                this.style = style;
            }
            return this;
        ...
        public AlertView.Builder setTitle(String title) {
            this.title = title;
            return this;
        }

        public AlertView.Builder setMessage(String msg) {
            this.msg = msg;
            return this;
        }

        public AlertView.Builder setCancelText(String cancel) {
            this.cancel = cancel;
            return this;
        }

        public AlertView.Builder setDestructive(String... destructive) {
            this.destructive = destructive;
            return this;
        }

        public AlertView.Builder setOthers(String[] others) {
            this.others = others;
            return this;
        }

        public AlertView.Builder setOnItemClickListener(OnItemClickListener onItemClickListener) {
            this.onItemClickListener = onItemClickListener;
            return this;
        }
