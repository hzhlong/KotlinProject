...
import com.kotlin.provider.common.ProviderConstant.Companion.KEY_SP_USER_MOBILE_FORVER
...
object UserPrefsUtils {
    ...
    fun putUserInfo(userInfo: UserInfo?) {
        ...
        if(userInfo?.userMobile != null){
            AppPrefsUtils.putString(ProviderConstant.KEY_SP_USER_MOBILE_FORVER, userInfo?.userMobile)
        }
    }
