...
class GoodsDetailTabOneFragment : BaseMvpFragment<GoodsDetailPresenter>(), GoodsDetailView  {
    ...
    private fun initView() {
        ...
        mGoodsDetailBanner.setBannerAnimation(Transformer.Accordion) // 设置viewpager的默认动画
        mGoodsDetailBanner.setDelayTime(2000) // 轮播间隔时间，默认2000
        mGoodsDetailBanner.setIndicatorGravity(BannerConfig.RIGHT)  // 设置指示器位置（当banner模式中有指示器时）
